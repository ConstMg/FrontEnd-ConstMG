        ...
        <div className='w-full max-w-6xl pb-8 bg-white rounded-tl-[50px] rounded-tr-[50px] p-10 md:p-8 flex flex-col md:flex-row gap-12 shadow-lg'>
          ...
          <div className='w-full md:w-1/2 space-y-8' data-aos='fade-right'>
            ...
            <div className='pl-6 space-y-6'>
              ...
              />
              <EditableField
                icon={<Mail size={22} className='text-yellow-600' />}
              ...
              />
              <EditableField
                icon={<Globe size={22} className='text-yellow-600' />}
              ...
              />
              <EditableField
                icon={<FacebookIcon size={22} className='text-yellow-600' />}
              ...
              />
              <EditableField
                icon={<Instagram size={22} className='text-yellow-600' />}
            ...
            <form
              ...
              <div className='flex flex-col md:flex-row gap-4 '>
                ...
                <input
                  ...
                  onChange={(e) => setContactFromEmail(e.target.value)} // Update state
              ...
              <input // Ini seharusnya input subject, bukan textarea pertama
                ...
                onChange={(e) => setContactSubject(e.target.value)} // Update state
                required // Wajib diisi
                disabled={sendingEmail} // Nonaktifkan saat mengirim
              />
              ...
              <textarea
                ...
                onChange={(e) => setContactMessage(e.target.value)} // Update state
                required // Wajib diisi
                disabled={sendingEmail} // Nonaktifkan saat mengirim
              ></textarea>
