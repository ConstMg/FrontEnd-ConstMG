...
const Project = () => {
    ...
    return (
        <>
            <div
                className="project h-dvh flex flex-col items-center gap-4 px-24 py-20 bg-white"
                id="project"
            >
                ...
                <p className="text-center text-gray-400 font-normal font-['Poppins']">
                    ...
                    Unde deleniti aperiam eligendi voluptatem! Repellat
                    necessitatibus qui quas! Obcaecati aspernatur, error odio
                    eum aliquam dicta! Blanditiis atque dicta reprehenderit
                    mollitia rem.
                </p>
