    ...
    if (initialData && variant === "update") {
      if (itemType === "karyawan") {
        ...
        setFormData({
          ...
          tanggal_dimulai_proyek: initialData.tanggal_dimulai_proyek || "",
          tanggal_selesai_proyek: initialData.tanggal_selesai_proyek || "",
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
      ...
      <div>
        ...
        <textarea
          ...
          required
          rows='3'
          className={commonInputClass}></textarea>
      </div>
    </div>
  );
    ...
    <>
      ...
      <div>
        ...
        <textarea
          ...
          onChange={handleChange}
          rows='2'
          className={`${commonInputClass} h-40`}></textarea>
      </div>
    </>
  );
